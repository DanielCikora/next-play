  ...
  return (
    <aside className='sidebar md:sticky static top-0 left-0 pt-26 w-full md:max-w-[350px] max-w-full mb-5'>
      <button
        ...
        className='cursor-pointer text-white p-3 md:hidden block border border-solid hover:bg-white hover:text-black transition-all duration-300 ease-in-out border-white rounded text-center w-full font-semibold'
      >
        Filters
      </button>
      <div
